        ...
        for i in pool_ids:
                ...
                for k in range(len(odds)):
                    ...
                    try:
                        ...
                        amo = 0.0
                        try:
                            ods = odds[k]['probable'] / 100
                            amo =  odds[k]['amount'] / 100
                        except:
                            ods = 0.0
                            amo = 0.0
                        ...
                        horses_for_json.append({"track": odds[k]['runnerNumber'],
                                ...
                                "win_money": win_money_2d[start_index_2][0][k],
                                "gender": gender_2d[start_index_2][0][k],
                                "probable": ods, #0.0, #odds[k]['probable'] / 100,
                                "amount": amo, #0.0, #odds[k]['amount'] / 100,
                        ...
                        print( {"track": odds[k]['runnerNumber'],
                                ...
                                "win_money": win_money_2d[start_index_2][0][k],
                                "gender": gender_2d[start_index_2][0][k],
                                #"probable": odds[k]['probable'],
                                #"amount": odds[k]['amount'],
        ...
        for i in range(len(data)):
            if data[i]['place'] == city:
                ...
                for k in range(len(horses)):
                    ...
                    temp.append(horses[k])
                
                
                race_horse = pd.DataFrame.from_dict(temp)
...
#make_h = make_horses('Vermo')
#print(make_h['horses'])
#city = check_races_for_city()
#print(city)